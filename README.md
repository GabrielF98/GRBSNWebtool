...
Alternatively if you have data for any of these associations that you wish to upload you can do so by first [forking](https://github.com/GabrielF98/GRBSNWebtool/fork) this repository and then suggesting changes via a pull request. You should add your files directly to the source file for that particular GRB-SN. These source files can be found [here](). You should also ensure that the citation file for the GRB-SN is updated correctly after data is added. The pull request should explain the type, format and source of the data as well as any other relevant information.

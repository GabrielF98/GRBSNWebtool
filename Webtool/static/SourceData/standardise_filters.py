...
def standard_filters(data):
    ...
    for i in range(0,len(bands)):
        if bands[i]=='SDSS-g' or bands[i]=='g$\\arcmin$' or bands[i] == 'g′':
            ...
            newbands.append(str('r'))
            continue
        elif bands[i]=='SDSS-i' or bands[i]=='i$\\arcmin$' or bands[i] == 'i′'or bands[i] =='ii':
            ...
            continue
        elif bands[i] == 'w1' or bands[i]=='W1'or bands[i]== 'Uw1'or bands[i]== 'uw1'or bands[i]== 'uvw1' or bands[i] == 'UVW1 (260 nm) Filter'\
            or bands[i] == 'UVW1':
            newbands.append('UW1')
            continue
        elif bands[i] == 'w2' or bands[i]=='W2'or bands[i]== 'Uw2'or  bands[i]== 'uw2'or bands[i]== 'uvw2'or bands[i] == 'UVW2 (198 nm) Filter' \
            or bands[i] == 'UVW2':
            newbands.append('UW2')
            continue
        elif bands[i] == 'm1' or bands[i]=='M1'or bands[i]== 'Um1' or bands[i]== 'um1'or bands[i]== 'uvm1'or bands[i] == 'UVM1':
            newbands.append('UM1')
            continue
        elif bands[i] == 'm2' or bands[i]=='M2'or bands[i]== 'Um2' or bands[i]== 'um2 'or bands[i]== 'uvm2'or bands[i] == 'UVM2' \
            or bands[i] == 'UVM2 (220 nm) Filter':
            newbands.append('UM2')
            continue
        elif bands[i] == 'u' or bands[i]=='U' or bands[i]== 'uvu' and instr[i] == 'UVOT' or instr[i] =='Swift/UVOT':
            newbands.append('UVU')
            continue
        elif bands[i] == 'b' or bands[i]=='B' or bands[i]== 'uvb' and instr[i] == 'UVOT' or instr[i] =='Swift/UVOT':
            newbands.append('UVB')
            continue
        elif bands[i] == 'v' or bands[i]=='V' or bands[i]== 'uvv' and instr[i] == 'UVOT' or instr[i] =='Swift/UVOT':
            newbands.append('UVV')
            continue
            ...
            newbands.append('K')
            continue
        elif bands[i] == 'Ks' or bands[i]=='K_{\\rm s}'or bands[i]== '$K_{\\rm s}$' or bands[i]=='K_{special}'or bands[i] == 'K_{s]}' or bands[i] == 'ks' or bands[i]=='k_{s}':
            ...
            continue
        elif bands[i] == 'Rc' or bands[i]=='R_{\\rm c}'or bands[i]=='RC' or bands[i]=='R_{C}':
            newbands.append('R_{c}')
            continue
        elif bands[i] == 'Clear':
            newbands.append('clear')
            continue
        elif bands[i] == 'CR' or bands[i]=='cr' or bands[i]=='Cr' or bands[i]== 'C_R':

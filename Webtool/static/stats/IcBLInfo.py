...
data = pd.read_csv('DataonIc-BLs.csv')

redshift = data['Redshift']
sn_names = data['Name']


spec_IcBLs_with_GRBs = ['2016jca', '2017htp', '2017iuk', '2018fip', '2019jrj', '2020bvc', '2020oi', 'AT2019oyw']

#Number of SN events per year with and without GRBs
event_years_with = [1, 2, 1, 2, 2, 0]

event_years_without = [0, 0, 0, 0, 0, 0]
...
labels = ['2016', '2017', '2018', '2019', '2020', 'October 2021']
width = 0.6
